...
const cartReducer = (state, action) => {
  ...
  switch (action.type) {
    ...
    case "sorted data":
      ...
      if (state.sortPriceValue === "mens-shoes") {
        console.log("sdfg");
        tempSortedData.map((item) => {
          if (item.category === "mens-shoes") {
            // return newSortData = [...item];
            
              laptopsData = [...laptopsData,item];
          }
          //   // else{
          //   //   return item;
          //   // }
    ...
    //   newSortData = tempSortedData.sort((a, b) =>
    //     a.price - b.price
    //   );
    ...
    return { ...state, totalProduct: laptopsData };
